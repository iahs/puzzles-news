      ...
      function ($stateProvider,   $urlRouterProvider) {
        ...
        $stateProvider
          ...
          .state("home", {
            ...
            // the posts.html file. So this template will be inserted into the
            // ui-view within posts.html.
          ...
          .state('contacts.detail', {
            ...
            views: {
              ...
              // This one is targeting the ui-view="hint" within the unnamed root, aka posts.html.
